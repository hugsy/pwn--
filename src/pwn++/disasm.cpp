...
namespace pwn::disasm
{
    ...
    namespace
    {
        ...
        disassemble_to_string(_In_ ZydisMachineMode arch, _In_ ZydisAddressWidth mode, _In_ const u8* code, _In_ const size_t code_size)
        {
                ...
                &instruction)))
            {
                ...
                ZydisFormatterFormatInstruction(
                    &formatter, &instruction, buffer, sizeof(buffer), runtime_address);
        ...
        void
        print_disassembled_code(_In_ ZydisMachineMode arch, _In_ ZydisAddressWidth mode, _In_ const u8* code, _In_ const size_t code_size)
        {
